<template>
    ...
    <div class="offcanvas offcanvas-end py-2 p-sm-4 p-md-5" id="cartOffcanvas" style="width: 680px;">
        ...
        <div class="px-4 pt-3">
            <div class="d-flex justify-content-between align-items-center border-bottom pb-3 pb-sm-4">
                <h2 class="offcanvas-title d-flex align-items-center mb-1">
                    Your purchases <span class="fs-base fw-normal text-body-secondary ms-3">(3 items)</span>
                </h2>
        ...
        <div class="offcanvas-body">
            ...
            <div class="d-sm-flex align-items-center pb-4">
                <a class="d-inline-block flex-shrink-0 bg-secondary rounded-1 p-sm-2 p-md-3 mb-2 mb-sm-0" href="shop-single.html"><img src="assets/img/shop/cart/01.png" width="110" alt="Product"></a>
        ...
        <div class="d-flex align-items-center justify-content-between px-4 pb-3">
            <div class="nav d-none d-sm-block">
                <a class="nav-link fw-semibold px-0" href="#cartOffcanvas" data-bs-dismiss="offcanvas">
                    <i class="ai-chevron-left fs-xl me-2"></i> Back to shop
                </a>
            </div>
    ...
    <input class="form-check-input" type="checkbox" id="theme-mode" v-model="isDarkMode">
...
<router-link to="#" class="btn btn-primary btn-sm fs-sm ms-3 mb-4 mb-lg-0 d-none d-lg-inline">
    <i class="ai-user me-2 ms-n1"></i>
    Sign up
</router-link>

                    <a class="nav-link position-relative fs-4 p-2" href="#cartOffcanvas" data-bs-toggle="offcanvas" aria-label="Shopping cart">
                        <i class="ai-cart"></i>
                        <span class="badge bg-primary fs-xs position-absolute end-0 top-0 me-n1" style="padding: .25rem .375rem;"></span>
                    </a>
                </div>
...
export default {
  ...
  mounted() {
    ...
    // SEO meta tags
    document.title = "Around | Shop Homepage v.1";
    ...
    this.addScriptTag("assets/js/theme-switcher.js");
